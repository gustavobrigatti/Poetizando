            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="?page=6">Administrador</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" action="login.php" data-toggle="dropdown"><b><?php echo $_SESSION['emailFuncionario']; ?></b><span class="caret"></span></a>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a href="?page=9">Minha conta</a>
                                            <br><br>
                                            <a href="?page=8">Trocar senha</a>
                                            <br><br>
